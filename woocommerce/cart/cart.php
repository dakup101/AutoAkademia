...
<div class="container cart-page">
    <div class="row">
        <div class="col-12 col-md-10 offset-md-1">
            <h1 class="wc-title">Twój Koszyk</h1>
            <?php
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                ...
                <div class="cart-actions row">
                    <div class="col-12 col-md-7">
                        ...
                        <div class="coupon">
                            <strong>Posiadasz kod rabatowy?</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <button type="submit" class="btn btn--outline" name="apply_coupon"
                                        value="<?php esc_attr_e( 'Zastosuj Kod Rabatowy', 'woocommerce' ); ?>">
                                        <?php esc_attr_e( 'Zastosuj Kod Rabatowy', 'woocommerce' ); ?>
                                    </button>
                                </div>
                            </div>
                ...
                <div class="cart-buttons">
                    <a class="btn btn--outline" href="<?php echo get_home_url(); ?>">Kontynuj Zakupy</a>
