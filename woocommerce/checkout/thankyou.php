...
<div class="container thank-you">
    <div class="row">
        <div class="col-12 col-md-10 offset-md-1">
            <h1 class="wc-title">Twój Zapis</h1>
            <?php
            ...
            <div class="woocommerce-order">
                ...
                <div class="thank-you-text">
                    ...
                    <div class="thank-you-order-info">
                        <p><strong>Numer Twojego zapisu: </strong><?php echo $order->get_order_number(); ?></p>
                        <p><strong>Kwota całkowita do spłaty: </strong><?php echo $order->get_formatted_order_total() ?>
                        </p>
                        <p>
                            <strong>Umowa: </strong>
                            <?php if (get_post_meta($order->get_id(), '_application', true)) echo '<a style="color: #f9dc06 !important; font-weight:bold; text-decoration: underline;" href="' . get_post_meta($order->get_id(), '_application', true) . '" target="_blank">Pobierz umowę</a>';
                                    ?>
                        </p>
                    </div>
